    ...
    >
      <div className="w-full">
        <img
          onClick={() => navigate("/")}
          src={assets.logo}
          className="w-46 ml-7 my-2 cursor-pointer"
          alt="logo"
        />
        ...
        <Link
          to="/create-post"
          className="flex items-center justify-center gap-2 m-4 py-2.5 mt-6 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95 transition text-white cursor-pointer"
        >
